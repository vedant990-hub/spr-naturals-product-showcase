...
export default function HomePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Form submission disabled; user should use the Email or WhatsApp buttons instead.
  };
              ...
              <Card className="p-8 bg-white border-sage-green/20 h-full">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-6">
                    <Button 
                      type="button"
                      onClick={() => window.location.href = "mailto:info@sprnaturals.in"}
                      className="flex-1 bg-nature-green hover:bg-leaf-green text-white py-6 text-lg font-medium shadow-md transition-all hover:shadow-lg"
                    >
                    ...
                    <Button 
                      type="button"
                      onClick={() => window.open("https://wa.me/917447755042", "_blank")}
                      className="flex-1 bg-[#25D366] hover:bg-[#128C7E] text-white py-6 text-lg font-medium shadow-md transition-all hover:shadow-lg"
                    >
